...
// ===============================================================================
// TIM2: CH2=PA1, CH3=PB10 — shared timer, ARR=63999 → 1 kHz at 64 MHz
// ===============================================================================
...
void TIM2_PWM_Init(void) {
  ...
  // CH3 (PB10)
  TIM2->CCR3 = 0;              // 25% duty cycle
  TIM2->CCMR2 &= ~(0x3UL << 0U);  // CC3S=00 (output)
  TIM2->CCMR2 &= ~(0x7UL << 4U);
  TIM2->CCMR2 |=  (0x6UL << 4U);  // OC3M=110 (PWM Mode 1)
...
void TIM4_PWM_Init(void) {
  ...
  TIM4->SMCR &= ~(0x7UL << 0U);
  TIM4->CR1 &= ~(0x3UL << 5U) & ~(0x1UL << 4U) & ~(0x1UL << 1U) &
               ~(0x1UL << 2U);
  TIM4->CR1 |= (0x1UL << 7U);
  ...
  // CH3 (PB8)
  TIM4->CCR3 = 0;
  TIM4->CCMR2 &= ~(0x3UL << 0U);  // CC3S=00 (output)
  TIM4->CCMR2 &= ~(0x7UL << 4U);
  TIM4->CCMR2 |=  (0x6UL << 4U);  // OC3M=110 (PWM Mode 1)
  ...
  // CH4 (PB9)
  TIM4->CCR4 = 0;
  TIM4->CCMR2 &= ~(0x3UL << 8U);  // CC4S=00 (output)
  TIM4->CCMR2 &= ~(0x7UL << 12U);
  TIM4->CCMR2 |=  (0x6UL << 12U); // OC4M=110 (PWM Mode 1)
